...
export class MenuScene extends SceneBase {
  ...
  constructor() {
    ...
    this.backmenu = new Sprite(
      Texture.from("backmenu")
    );
    ...
    const tStyle = new TextStyle({
      fontSize: 150, fill: 0x550055, dropShadow: true, dropShadowColor: 0xFF0000,
    })

    this.welcomeTo = new Text("Jumping Cat Flash", tStyle);
    this.addChild(this.welcomeTo);

    this.idleCat = new AnimatedSprite(
